...
- (instancetype)init{
	return [self initWithFrame:CGRectMake(0, 0, 20, 20) andLineColor:[UIColor blueColor] andLineBgColor:[UIColor lightGrayColor]];
}

- (instancetype)initWithFrame:(CGRect)frame{
	return [self initWithFrame:frame andLineColor:[UIColor blueColor] andLineBgColor:[UIColor lightGrayColor]];
}
