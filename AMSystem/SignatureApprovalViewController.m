...
-(void)initBatchApproveBtn{
     self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:@"批量审核" style:UIBarButtonItemStylePlain target:self action:@selector(remindAndSubmitAction:)];
}
//手势手指拖事件
